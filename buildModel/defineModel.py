...
############################ Inception 1 ###############################
layer1_width = conv1_features + conv1_ref_features
...
resulting_width = 750#target_size // (max_pool_size_stem * max_pool_size1 * max_pool_size2 * max_pool_size3* max_pool_size4
                                 # * max_pool_size5  )#* max_pool_size6 )

full1_input_size = resulting_width * (layer6_width) #( layer_full_width )
